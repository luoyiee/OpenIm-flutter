...
class ChatFileVideoView extends StatefulWidget {
  const ChatFileVideoView({
    Key? key,
  ...
  @override
  State<ChatFileVideoView> createState() => _ChatFileVideoViewState();
}

class _ChatFileVideoViewState extends State<ChatFileVideoView> {
  ...
  @override
  void initState() {
    final video = _message.fileElem;
    // _snapshotUrl = video?.snapshotUrl;
    _snapshotPath = video?.filePath;

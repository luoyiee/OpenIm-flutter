...
class AppNavigator {
 ...
 String? phoneNumber,
  ...
  static Future<T?>? startFriendInfo<T>({
    required UserFullInfo userInfo,
    String? groupID,
  ...
  static void startSendFriendRequest({required UserFullInfo info}) {
  ...
  static void createGroup({
    ...
    // 发起人
    final myself = OpenIM.iMManager.userID;
    ...
    var list = await startSelectContacts(
      action: SelAction.crateGroup,
      defaultCheckedIDList: defaultCheckedUidList,
    );
    if (null != list) {
